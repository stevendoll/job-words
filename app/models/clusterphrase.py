...
class ClusterPhrase(db.Model):
    ...
    def serialize(self):
        result = {}
        result["clusterTitle"] = self.cluster.title if self.cluster else None
    ...
    def __repr__(self):
        return "<ClusterPhrase {}>".format(self.phrase)

    @staticmethod
    def get_all():
        return ClusterPhrase.query.all()
